# Operator Quickstart — Petroleum refining

Shortest path from clone to a verified local dry-run for **ISIC 1920** (`cloud-itonami-isic-1920`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1920.git
cd cloud-itonami-isic-1920
```
...
- Blueprint governor key: `refinery-safety-governor`
- Likely source path: `refining.governor.cljc`
